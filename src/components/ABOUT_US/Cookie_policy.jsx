...
import "../ABOUT_US/cookie_policy.css"
    ...
    <div>
      <Nav/>
            ...
            <div className="cookie_container">
             <div className='cookie_tit'>
             <h1>Cookie Policy</h1>
                <p className='cookie_para'>This is the Cookie Policy for www.bitss.fr, accessible from https://bitss.fr/
           ...
           <div className='cookie_tit'> 
                  <h1> More Information</h1>
                   ...
                   <ul className='cookie_ul'>
                    <li>Email: support@bobosohomail.com</li>
                   </ul>
           </div>
